...
function setTypeBackgroundColor(pokemon) {
    ...
    setElementStyles(document.querySelectorAll(".stats-wrap p.stats > p"), "color", color);
    setElementStyles(document.querySelectorAll(".stats-wrap .progress-bar> p"), "color", color);
...
function displayPokemonDetails(pokemon) {
    ...
    const capitalisePokemonName = capitalizeFirstLetter(name);

    document.querySelector("title").textContent = capitalisePokemonName;
    const detailMainElement = document.querySelector(".detail-main");
    detailMainElement.classList.add(name.toLowerCase());

    document.querySelector(".name-wrap .name").textContent = capitalisePokemonName;
